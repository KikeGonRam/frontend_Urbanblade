...
<template>
  <div
    class="flex min-h-screen flex-col items-center justify-center gap-4 bg-main p-6 text-center"
  >
    <template v-if="!failed">
      <div
        class="h-8 w-8 animate-spin rounded-full border-2 border-gold border-t-transparent"
      />
    ...
    <template v-else>
      ...
      <NuxtLink to="/login" class="text-sm text-gold hover:underline"
        >Volver a intentar</NuxtLink
      >
    </template>
  </div>
</template>
